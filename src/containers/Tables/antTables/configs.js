...
const columns = [
  ...
  {
    title: <IntlMessages id="Director" />,
    key: 'firstName',
    width: 100,
    render: object => renderCell(object, 'TextCell', 'director')
  },
  {
    title: <IntlMessages id="Hospital Name" />,
    key: 'lastName',
    width: 200,
    render: object => renderCell(object, 'TextCell', 'hospitalName')
  },
  {
    title: <IntlMessages id="No. of Patients" />,
    key: 'noOfPatients',
    width: 50,
    render: object => renderCell(object, 'TextCell', 'noOfPatients')
  },
  {
